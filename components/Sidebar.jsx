...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const [currentItems, setCurrentItems] = useState(userNavigationItems);
  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      if (parsedUser.role === 'admin') {
        setCurrentItems(adminNavigationItems);
      } else {
        setCurrentItems(userNavigationItems);
      }
    }
  }, []);
